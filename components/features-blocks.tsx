      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">了解更多？</h2>
            <p className="text-xl text-gray-600">通过注册成为我们的会员，您可以立即获取本地的各类兼职招聘信息，直接与企业用人单位或是私人个体对接协商。</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">专业团队</h4>
              <p className="text-gray-600 text-center">专业团队为您保驾护航。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">安全省心</h4>
              <p className="text-gray-600 text-center">安全快速保护客户隐私</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">省时省力</h4>
              <p className="text-gray-600 text-center">线上线下对接省时高效</p>
            </div>
